...
class UploadLoader extends StatefulWidget {
  ...
  const UploadLoader(
      {required this.upperLeft, required this.upperRight, required this.lowerLeft, required this.lowerRight});
...
class _UploadLoaderState extends State<UploadLoader>
  ...
  late AnimationController _successIconAnimationController;
  late Animation<Offset> _successIconAnimation;
                ...
                child: AnimatedContainer(
                  ...
                  child: SlideTransition(
                    position: uploadSuccess
                        ? _successIconAnimation : _uploadIconAnimation,
                    child: Icon(
                      _isLoading
