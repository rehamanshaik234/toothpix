          ...
          return Container(
            ...
            child: Wrap(
              children: <Widget>[
                ...
                InkWell(
                  onTap: () async {
                    XFile? pickedImage = await ImagePicker.platform.getImageFromSource(
                            ...
                            Row(
                              children: [
                                ...
                                UploadOpenContainer(
                                  ...
                                  imageFile: upperRightImage ?? File(''),
                                ),
                              ],
                            ),
                            Row(
                              children: [
                                ...
                                UploadOpenContainer(
                                  ...
                                  imageFile: lowerRightImage ?? File(''),
                                ),
                              ],
                            ),
                          ],
                            ...
                            if (connectivityResult == ConnectivityResult.none) {
                              ...
                              var dummy = await Navigator.of(context).push(
                                MaterialPageRoute(
                                    builder: (BuildContext context) =>
                                        UploadLoader(
                                          upperLeft: upperLeftImage ?? File(''),
                                          upperRight: upperRightImage ?? File(''),
                                          lowerLeft: lowerLeftImage ?? File(''),
                                          lowerRight: lowerRightImage ?? File(''),
                                        )),
                              );
                            }
                            _showSnackBar('Something Went Wrong');
