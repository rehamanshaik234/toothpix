...
class HistoryDetails extends StatefulWidget {
  ...
  HistoryDetails({required this.recommendDate, required this.id, required this.status});
...
class _HistoryDetailsState extends State<HistoryDetails> {
  ...
  late HistoryDetailsResponse historyDetailsResponse;
                              ...
                              child: SingleChildScrollView(
                                ...
                                child: Text(
                                  recommendation.isEmpty
                                      ...
                                      : recommendation,
                                  style:
                                      GoogleFonts.sourceSans3(fontSize: 15.0),
                                ),
                              ),
                            ),
                          ),
...
class ProblemIndicator extends StatelessWidget {
  ...
  const ProblemIndicator({required this.result, required this.type});
